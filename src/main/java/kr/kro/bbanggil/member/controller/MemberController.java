...
public class MemberController {
	...
	// 체크박스 페이지 (일반/사업자 구분)
	@GetMapping("/checkbox")
	public String checkBox(@RequestParam(value = "type", required = false, defaultValue = "user") String type,
			Model model) {
	...
	public String saveCheckBox(@ModelAttribute MemberRequestCheckBoxDto checkBoxDto,
			@RequestParam(value = "type", required = false, defaultValue = "user") String type, HttpSession session,
			Model model) {
