...
public class NewsletterScheduler {
	...
	public void sendWeeklyNewsletter() {
		...
		String imageUrl = "http://www.bbanggil.kro.kr" + resourcesPath + "/" + changeName;
		...
		String body = String.format("""
		    ...
		    <div class="container">
		        <h1>🍞 이주의 추천 빵집</h1>
		        <img src="%s" alt="추천 빵집 이미지" class="image">
		        ...
		        <a href="http://www.bbanggil.kro.kr/newsletter" class="button">자세히 보기</a>
		...
		""", imageUrl, bakeryName, openTime, closeTime);
